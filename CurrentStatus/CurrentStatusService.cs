...
namespace FinancialPlanner.BusinessLogic.CurrentStatus
{
    public class CurrentStatusService
    {
        ...
        readonly string GET_EQUITY_NPS_VALUE = "SELECT SUM(((NAV * UNITS) * EQUITYRATIO /100)) AS EQUITYNPSSHARES," +
            "SUM(((NAV * UNITS) * DEBTRATIO /100)) AS DEBTNPSSHARES," +
            "SUM(((NAV * UNITS) * GOLDRATIO /100)) AS GOLDNPSSHARES," +
            "SUM((NAV * UNITS)) AS TOTALVALUE FROM [NPS] WHERE PID ={0} AND GOALID = {1} ";

        readonly string GET_EQUITY_ULIP_VALUE = "SELECT SUM(((NAV * UNITS) * EQUITYRATIO /100)) AS EQUITYULIPSHARES," +
          "SUM(((NAV * UNITS) * DEBTRATIO /100)) AS DEBTULIPSHARES," +
          "SUM(((NAV * UNITS) * GOLDRATIO /100)) AS GOLDULIPSHARES," +
          "SUM((NAV * UNITS)) AS TOTALVALUE FROM [ULIP] WHERE PID ={0} AND GOALID = {1} ";
        ...
        readonly string GET_ALL_EQUITY_NPS_VALUE = "SELECT SUM(((NAV * UNITS) * EQUITYRATIO /100)) AS EQUITYNPSSHARES," +
            "SUM(((NAV * UNITS) * DEBTRATIO /100)) AS DEBTNPSSHARES," +
            "SUM(((NAV * UNITS) * GOLDRATIO /100)) AS GOLDNPSSHARES," +
            "SUM((NAV * UNITS)) AS TOTALVALUE FROM [NPS] WHERE PID ={0} ";

        readonly string GET_ALL_EQUITY_ULIP_VALUE = "SELECT SUM(((NAV * UNITS) * EQUITYRATIO /100)) AS EQUITYULIPSHARES," +
            "SUM(((NAV * UNITS) * DEBTRATIO /100)) AS DEBTULIPSHARES," +
            "SUM(((NAV * UNITS) * GOLDRATIO /100)) AS GOLDULIPSHARES," +
            "SUM((NAV * UNITS)) AS TOTALVALUE FROM [ULIP] WHERE PID ={0} ";
